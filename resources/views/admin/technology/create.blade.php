...
@section('content')
    <main class="p-6">
        ...
        <div class="flex justify-between items-center mb-6">
            <h4 class="text-slate-900 dark:text-slate-200 text-lg font-medium">Technology</h4>
            ...
            <div class="md:flex hidden items-center gap-2.5 font-semibold">
                <div class="flex items-center gap-2">
                    ...
                    <a href="" class="text-sm font-medium text-slate-700 dark:text-slate-400"
                        aria-current="page">Create Technologies
                    </a>
                </div>
            </div>
        </div>
                            ...
                            <div class="card mb-6">
                                <div class="bg-black/5 card-header flex items-center justify-between mb-5">
                                    <h5 class="text-base/3 text-gray-800 font-normal mt-0 card-title"
                                        ...
                                        Upload Images of Tech you use.</h5>
                                </div>

                                <form class="px-5" action="{{ route('technology.store') }}" method="POST"
                                    enctype="multipart/form-data">
                                    @csrf

                                    @include('admin.technology.partials.form')
